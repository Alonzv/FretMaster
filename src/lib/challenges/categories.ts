...
// Stage 1
import { generateMajorScaleQuestion }        from './generators/majorScale'
// Stage 2
import { generateDiatonicHarmonyQuestion }   from './generators/diatonicHarmony'
import { generateCagedSystemQuestion }       from './generators/cagedSystem'
...
import { generateVoiceLeadingQuestion }      from './generators/voiceLeading'
...
export const CATEGORIES: CategoryEntry[] = [
  ...
  // ── Stage 2 — Intermediate ───────────────────────────────────────────────
  {
    ...
    generator: generateDiatonicHarmonyQuestion,
  },
  {
    id: 'caged_system',
    titleHe: 'מערכת CAGED',
    ...
    phase: 1,
    icon: 'M3 7h18v2H3V7zm0 4h18v2H3v-2zm0 4h18v2H3v-2z',
    generator: generateCagedSystemQuestion,
  },
  {
    id: 'seventh_chords',
    ...
    generator: generateSeventhChordsQuestion,
  },
  {
    id: 'pentatonic_blues',
    ...
    generator: generatePentatonicBluesQuestion,
  },
  {
    id: 'minor_scales',
    ...
    phase: 1,
    icon: 'M3 3h2v18H3V3zm16 0h2v18h-2V3zM7 7h2v14H7V7zm4-4h2v18h-2V3zm4 4h2v14h-2V7z',
    generator: generateMinorScalesQuestion,
  },
  ...
  // ── Stage 3 — Advanced ───────────────────────────────────────────────────
  {
    ...
    generator: generateModesTheoryQuestion,
  },
  {
    ...
    descEn: 'Borrowing chords from parallel minor',
    phase: 1,
    icon: 'M7 16V4m0 0L3 8m4-4l4 4M17 8v12m0 0l4-4m-4 4l-4-4',
    generator: generateModalInterchangeQuestion,
  },
  {
    id: 'voice_leading',
    ...
    phase: 1,
    icon: 'M9 3v12.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h6V3H9z',
    generator: generateVoiceLeadingQuestion,
  },
  {
    id: 'polyrhythm',
    titleHe: 'פולירית׳ם',
    ...
    generator: generatePolyrhythmQuestion,
  },
  {
    id: 'chord_soloing',
    ...
    generator: generateChordToneSoloingQuestion,
  },
