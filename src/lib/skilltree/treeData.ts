...
export const TREE_NODES: TreeNode[] = [
  ...
  },
  {
    ...
    categoryId: 'genre_country',
    difficulty: 'hard',
    titleHe: 'קאנטרי — מתקדם',
    titleEn: 'Country Advanced',
    descHe: 'Nashville Number System, pedal steel, Bakersfield sound',
    descEn: 'Nashville Number System, pedal steel, Bakersfield sound',
    requires: ['country_easy'],
    xpReward: 55,
    icon: 'M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5',
  },
  {
    ...
    difficulty: 'hard',
    titleHe: 'מטאל — מתקדם',
    titleEn: 'Metal Advanced',
    descHe: 'Sweep picking, economy picking, neoclassical, polyrhythm',
    descEn: 'Sweep picking, economy picking, neoclassical, polyrhythm',
    requires: ['metal_easy', 'jazz_easy'],
    xpReward: 65,
    icon: 'M7 4v16M17 4v16M3 8h4m10 0h4M3 16h4m10 0h4M7 12h10',
  },
  {
    ...
    difficulty: 'hard',
    titleHe: 'פולק — מתקדם',
    titleEn: 'Folk Advanced',
    descHe: 'Counterpoint, scordatura, modal folk, Carter Family picking',
    descEn: 'Counterpoint, scordatura, modal folk, Carter Family picking',
    requires: ['folk_easy', 'scales_hard'],
    xpReward: 55,
    icon: 'M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm-5-9h10v2H7v-2z',
  },
  {
